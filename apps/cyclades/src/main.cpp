...
// Sample call: ./cyclades -matrix_inverse -n_threads=2  -cyclades_trainer  -cyclades_batch_size=500
// -learning_rate=.000001 --print_partition_time -n_epochs=20 -sgd -print_loss_per_epoch
// --data_file="data/nh2010/nh2010.data"
...
DEFINE_bool(fast_matrix_completion, false,
            "Matrix completion with custom sgd updater. Do not specify an extra updater (e.g: don't specify "
            "--sparse_sgd, etc)");
DEFINE_bool(word_embeddings, false,
            "W2V application type. Do NOT set an updater (E.G: sparse_sgd) if you want to use the default optimizer "
            "which optimizes C.");
